...
import ProductBooking from '../ModalComponent/ProductBooking'
import { bookProduct } from '../Service/BookProduct'
...
const [errorMsg, setErrorMsg] = useState("")
  ...
  const handleSubmit = () => {
   ...
   let finalCart = JSON.parse(localStorage.getItem("cart"))
    ...
    const order = new ProductBooking(productId, quantity, localStorage.getItem("loginId"), email, mobileNo, country, state, district, address, pincode)
    console.log(order)
    bookProduct(order)
    .then((res) =>{
